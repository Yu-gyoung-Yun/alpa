...
class ParallelizedFunc:
    ...
    def __call__(self, *args):
        ...
        #executable.dump_debug_info("/alpa/examples/gpt2/dp_op_pp/ex")
        geet_stage_allocation_size = executable.get_stage_allocation_size()
        print(f"total_allocation_size: "
                        f"{np.mean(geet_stage_allocation_size)/(1024**3):.3f} GB\n")
        print("allocation_size: ", geet_stage_allocation_size)
