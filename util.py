...
def profile_xla_executable(compiled, backend, local_devices):
    ...
    #with open("/alpa/examples/gpt2/dp_op_pp/output/64/023_hlocostmodule_test_seqlen64_gpt2_1_5B_all_01234_warmup_1_3_3_2_1_4_out_8_layer_auto.txt", "a") as f:
    #    print("profile_xla_executable.py", file = f)
